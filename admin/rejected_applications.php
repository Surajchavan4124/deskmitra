      ...
      <div class="main">
        ...
        <main class="content px-3 py-4">
          <div class="container-fluid">
            <div class="mb-3">
              <h3 class="fw-bold fs-4 mb-3">Admin Dashboard (Applications Rejected)</h3>
              <div class="row g-2">
              ...
              <h3 class="fw-bold fs-4 my-3">Applications Rejected</h3>
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-hover table-bordered text-nowrap">
                    ...
                    <tbody>
                      <?php
                      $sql_qyery = "SELECT * FROM services WHERE status = 'rejected'";
                          ...
                          <tr>
                            ...
                            <form action="update_application_status.php" method="post">
                                ...
                                <select name="status" id="status" class="form-control">
                                    ...
                                    <option value="under processcompleted" <?= $row["status"] == 'under process' ? 'selected' : '' ?>>under process</option>
