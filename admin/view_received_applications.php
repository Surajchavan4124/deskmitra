...
$db = new mysqli($servername, $username, $password, $database, $port);
        ...
        <main class="content px-3 py-4">
          <div class="container-fluid">
            <div class="mb-3">
              <h3 class="fw-bold fs-4 mb-3">Admin Dashboard (Applications received)</h3>
              <div class="row g-2">
              ...
              <h3 class="fw-bold fs-4 my-3">Applications Received</h3>
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-hover table-bordered text-nowrap">
                    ...
                    <tbody>
                      <?php
                      $sql_qyery = "SELECT * FROM services WHERE status = 'received'";
